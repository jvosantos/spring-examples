...
public class MessageChecker2 implements BeanPostProcessor, PriorityOrdered {
  private int order = 0;
  ...
  public Object postProcessBeforeInitialization(Object bean, String beanName)
    ...
    if (bean instanceof MessageOfTheDayService) {
      ...
      if (!messageOfTheDayService.getMessage().isEmpty()) {
        System.out.println("MessageChecker2 --> Before initialization: " + beanName + " contains "
  ...
  public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
    if (bean instanceof MessageOfTheDayService) {
      MessageOfTheDayService messageOfTheDayService = (MessageOfTheDayService) bean;
      if (!messageOfTheDayService.getMessage().isEmpty()) {
        System.out.println("MessageChecker2 --> After initialization: " + beanName + " contains "
            + messageOfTheDayService.getMessage());
      }
    }
