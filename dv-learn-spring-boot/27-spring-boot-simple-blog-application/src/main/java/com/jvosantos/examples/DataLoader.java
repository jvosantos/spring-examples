...
public class DataLoader {
	...
	private void loadData(){
		...
		// create an author
		Author dv = new Author("Vasco","Santos","jvosantos@gmail.com");
	...
	private void createAuthors() {
		Author jv = new Author("Luis","Prates","prates23@gmail.com");
		authorRepository.save(jv);
		Author av = new Author("Angelo","Veiga","anveiga31@gmail.com");
		authorRepository.save(av);
		Author kv = new Author("Frederico","Miranda","fred@jvosantos.com");
